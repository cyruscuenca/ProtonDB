<nav class="navbar navbar-expand-lg mb-4">
    <a href="{{ route('frontend.index') }}" class="navbar-brand"><img src="{{asset('img/backend/brand/logo.png')}}"></a>
        ...
        <ul class="navbar-nav">
            @auth
                <div class="nav-dashboard">
                    <li class="nav-item"><a href="{{route('frontend.user.dashboard')}}" class="nav-link {{ active_class(Active::checkRoute('frontend.user.dashboard')) }}"><img src="{{asset('img/backend/icons/dashboard.svg')}}">@lang('navs.frontend.dashboard')</a></li>
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" id="navbarDropdownMenuUser" data-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false"><img src="{{asset('img/backend/icons/account.svg')}}">{{ $logged_in_user->name }} &nbsp;</a>
            ...
            @if(config('locale.status') && count(config('locale.languages')) > 1)
                <li class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" id="navbarDropdownLanguageLink" data-toggle="dropdown"
                       aria-haspopup="true" aria-expanded="false"><img src="{{asset('img/backend/icons/lang.svg')}}">@lang('menus.language-picker.language') ({{ strtoupper(app()->getLocale()) }}) &nbsp;</a>

                    @include('includes.partials.lang')
                </li>
            @endif

            <li class="nav-item"><a href="{{route('frontend.contact')}}" class="nav-link {{ active_class(Active::checkRoute('frontend.contact')) }}"><img src="{{asset('img/backend/icons/contact.svg')}}">@lang('navs.frontend.contact')</a></li>
        </ul>
    </div>
    <div class="navbar-social">
        <ul>
            <li><a href="https://discord.gg/WgTqf3p">
            ...
            <li><a href="https://twitter.com/steamplaygames">
